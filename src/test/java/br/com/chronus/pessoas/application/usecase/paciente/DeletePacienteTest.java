...
class DeletePacienteTest {

    @Mock
    private PacienteGateway pacienteGateway;

    @InjectMocks
    private DeletePaciente deletePaciente;
    ...
    void deveLancarExcecaoQuandoPacienteNaoEncontrado() {
        ...
        verify(pacienteGateway, never()).deletePaciente(anyInt());
    }
